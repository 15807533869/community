...
import com.itao.community.service.AlphaService;
...
public class AlphaController {
    ...
    public String setCookie(HttpServletResponse response) {
        // 创建Cookie
        Cookie cookie = new Cookie("code", CommunityUtil.gennerateUUID());
        // 设置cookie生效的范围
